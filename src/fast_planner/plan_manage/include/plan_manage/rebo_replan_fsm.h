...
private:
  ...
  plan_manage::DataDisp data_disp_;
  ...
  Eigen::Vector3d local_target_pt_, local_target_vel_;                      // target state
  int current_wp_;
  ...
  void getLocalTargetSphere();
  void getLocalTarget();
  void getLocalTargetT();
  ...
  bool checkCollision();
  Eigen::Vector3d estimateAcc(const nav_msgs::OdometryConstPtr& msg);
