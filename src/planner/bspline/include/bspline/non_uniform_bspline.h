...
public:
  ...
  bool   reallocateTime_mod(bool show = false);
  bool   reallocateTime_mod2(bool show = false);

  bool   adjustFirst3CtrlPoints(const Eigen::Vector3d pos, const Eigen::Vector3d vel, const Eigen::Vector3d acc);
